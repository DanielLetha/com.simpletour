...
public class AgreementProductRefundRule{
    ...
    public AgreementProductRefundRule() {
    }

    public AgreementProductRefundRule(AgreementProduct agreementProduct, Integer ratio, Integer timing) {
