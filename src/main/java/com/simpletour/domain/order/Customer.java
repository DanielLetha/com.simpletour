...
public class Customer{
    ...
    public Customer(Order order, Item item, Type type, String name, String mobile, IdType idType, String idNo, String email, String code, String remark) {
        this.order = order;
        this.item = item;
        this.type = type;
        this.name = name;
    ...
    public Customer updateBasic(String name, String mobile, IdType idType, String idNo, String email) {
        this.name = name;
        this.mobile = mobile;
        this.idType = idType;
        this.idNo = idNo;
    ...
    public static boolean accept(String idType) {
        for (IdType enumType : IdType.values()) {
            if (enumType.name().equals(idType))
                return true;
        }
        return false;
    }

    public static IdType of(String idType) {
        if (accept(idType)) {
